...
#define TOTAL_TEXTURES 1
static const char * const bmps[TOTAL_TEXTURES] = { "sprite.bmp" };
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    if (!SDL_CreateWindowAndRenderer("Sprite Test", 240 * 4, 160 * 4, 0, &window, &renderer)) {
...
SDL_AppResult SDL_AppIterate(void *appstate)
{
    ...
    SDL_SetRenderDrawColor(renderer, 180, 255, 255, 124);
